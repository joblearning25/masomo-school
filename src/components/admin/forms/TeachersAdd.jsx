...
const TeachersAdd = () => {
    ...
    const handleSubmit=async (e) => {
        ...
        try {
            ...
            const res= await axios.post('https://schoolapi-92n6.onrender.com/api/teacher',data,authHeader)
            toast.dismiss()
    ...
    <div className='container mt-2'>
        ...
        <nav aria-label='breadcrumb' className='mb-3'>
            <ol className='breadcrumb'>
                ...
                <li className='breadcrumb-item- active' aria-label='page'> / Add Teacher</li>
            </ol>
        </nav>
        ...
        <div className="card p-4 shadow-sm mb-4">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h5 className='text-success '> 
                    <i className='bi bi-person-badge-fill me-2'></i> Add New Teacher
                </h5>

                <Link className='btn btn-success' to={'/admin-dasboard/teachers'}>
            ...
            <form onSubmit={handleSubmit} >
                ...
                <button type='submit' className='btn btn-success'>
                    <i className='bi bi-save me-2'></i>Save Teacher
                </button>
            </form>
